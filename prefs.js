...
export default class CryptoGoldPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        window.set_default_size(650, 520);
        ...
        // Add thanks section at the bottom of the main page as a simple label
        const thanksLabel = new Gtk.Label({
            label: 'Thanks "Batman" for the feature ideas❤️',
        ...
        // Wrap the label in a simple container
